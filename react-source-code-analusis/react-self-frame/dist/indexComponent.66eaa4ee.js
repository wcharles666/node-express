...
var createComponent = function createComponent(comp, props) {
  ...
  if (comp.prototype && comp.prototype instanceof _react.default.Component) {
    ...
    inst = new _componentNormalDiff.default(props); // 改变构造函数的指向x
...
var _render = function _render(vnode) {
  ...
  if (typeof vnode.tag === "function") {
    // 1. 创建组件
    var comp = createComponent(vnode.tag, vnode.attrs); // 2. 设置组件的属性xxx
...
var Component = /*#__PURE__*/function () {
  ...
  _createClass(Component, [{
    ...
    value: function setState(stateChange) {
      ...
      // // 直接简单一点，进行浅拷贝
      // // 对象拷贝
      Object.assign(this.state, stateChange); // 状态改变, 渲染组件
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"indexComponent.js":[function(require,module,exports) {
"use strict";

var _react = _interopRequireDefault(require("./react"));

var _componentPart = _interopRequireDefault(require("./react-dom/componentPart"));
...
var Home = function Home(props) {
  return _react.default.createElement("div", {
    className: "active",
    title: "1232"
  }, "hello", _react.default.createElement("span", null, "react \u6570\u91CF", props.name));
};
...
console.log(_react.default.createElement(ClassComponet, {
  name: "class"
}), "ClassComponet"); // 函数组件
// ReactDOM.render(<Home name="home" />, document.getElementById("root"));
// 类组件

_componentPart.default.render(_react.default.createElement(ClassComponet, {
  name: "home"
}), document.getElementById("root"));
},{"./react":"react/index.js","./react-dom/componentPart":"react-dom/componentPart.js","./index.css":"index.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","indexComponent.js"], null)
//# sourceMappingURL=/indexComponent.66eaa4ee.js.map